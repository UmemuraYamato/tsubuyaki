...
public class TsubuyakiService {
    ...
    private final TsubuyakiRepository tsubuyakiRepository;
    ...
    // コメントでつぶやきを検索するサービスメソッド
    public List<Tsubuyaki> findByComment(String comment) {
     return tsubuyakiRepository.findByComment(comment);
    }
